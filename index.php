	...
	<section id="about" class="info">
		<div class="container">
			...
			<div class="text_info">
				<div class="item_info">
					<div class="item_img">
						<img src="img/about/new/hum.webp" alt="DHT11">
					</div>
				...
				<div class="item_info">
					<div class="item_img">
						<img src="img/about/new/wifi.webp" alt="Wi-Fi Module">
					</div>
					<h3>Wi-Fi Module</h3>
				...
				<div class="item_info">
					<div class="item_img">
						<img src="img/about/new/sensor.webp" alt="UltraSonic Sensor">
					</div>
				...
				<div class="item_info">
					<div class="item_img">
						<img src="img/about/new/gsm.webp" alt="SIM900A">
					</div>
			...
			<div class="garbage_connect">
				<div class="info_garbage">
					<?php
                        ...
                        if($row["data_sensor"] >= 60){
                            echo "<img src='img/new/03.webp' alt='Status garbage' class='garbage' width='116px' height='165px'>";
                        }
                        else {
                            echo "<img src='img/new/02.webp' alt='Status garbage' class='garbage' width='116px' height='165px'>";
                        }
                    ?>
				...
				<div class="metric_garbage">
					<div class="metric_full">
                        ...
                        ?>
						<div class="full" data-percent="<?=$row['data_sensor']?>">
						</div>
					...
					<div class="metric_full">
                        ...
                        $row= mysqli_fetch_assoc($result);
                        ?>
						<div class="temp" data-percent="<?=$row['data_temp']?>">
						</div>
						<div class="metric_info">
					...
					<div class="metric_full">
                        ...
                        $row= mysqli_fetch_assoc($result);
                        ?>
						<div class="hum" data-percent="<?=$row['data_hum']?>">
						</div>
						<div class="metric_info">
